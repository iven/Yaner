...
;  File "QtXml4.dll"
  File "yaner.exe"
  File "@CMAKE_SOURCE_DIR@/share/yaner.ico"
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\@PROJECT_NAME_SHORT@" "DisplayIcon" '"$INSTDIR\yaner.exe"'
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\@PROJECT_NAME_SHORT@" "DisplayVersion" "@PROJECT_VERSION@"
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\@PROJECT_NAME_SHORT@" "Publisher" "Iven Hsu"
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\@PROJECT_NAME_SHORT@" "URLInfoAbout" "http://www.kissuki.com/Yaner"
  ...
  ;${registerExtension} "$INSTDIR\yaner.exe" ".bbf" "Bla bla file format"
...
Section "Start Menu Shortcuts"
  ...
  CreateShortCut "$SMPROGRAMS\@PROJECT_NAME_LONG@\@PROJECT_NAME_SHORT@.lnk" "$INSTDIR\yaner.exe" "" "$INSTDIR\yaner.ico" 0
...
Section "Desktop Shortcut"
  ...
  CreateShortCut "$DESKTOP\@PROJECT_NAME_LONG@.lnk" "$INSTDIR\yaner.exe" "" "$INSTDIR\yaner.ico" 0
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\yaner.exe"
  Delete "$INSTDIR\yaner.ico"
